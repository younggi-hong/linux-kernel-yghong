...
{
	//if ( irq == IRQ_EINT15)
	//	printk("[handle_edge_irq] SHKO1 : irq=%d\n", irq);
		
	raw_spin_lock(&desc->lock);

	//if ( irq == IRQ_EINT15)
	//	printk("[handle_edge_irq] SHKO2 : irq=%d\n", irq);
	...
	//if ( irq == IRQ_EINT15)
	//	printk("[handle_edge_irq] SHKO start2\n");
