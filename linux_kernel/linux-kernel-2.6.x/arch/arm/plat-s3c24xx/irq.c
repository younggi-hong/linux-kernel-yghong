...
s3c_irqext_unmask(struct irq_data *data)
{
	...
	//printk("[s3c_irqext_unmask]SHKO, %d\n", data->irq);
...
/* SHKO, CONFIG_FIQ is not defined */
#ifdef CONFIG_FIQ
	init_FIQ();
#endif

	printk("[s3c24xx_init_irq] SHKO : Start\n");		//SHKO, Added
