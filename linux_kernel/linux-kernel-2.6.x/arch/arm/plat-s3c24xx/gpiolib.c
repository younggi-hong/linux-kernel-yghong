...
struct s3c_gpio_chip s3c24xx_gpios[] = {
	[0] = {
		.base	= S3C2410_GPACON,									/* Virtual Address */
		.pm	= __gpio_pm(&s3c_gpio_pm_1bit),
		.config	= &s3c24xx_gpiocfg_banka,
		.chip	= {
			.base			= S3C2410_GPA(0),						/* 0 */
			.owner			= THIS_MODULE,
			.label			= "GPIOA",
			.ngpio			= 24,
